...
Hexo是一个基于Node.js的博客框架，从模板、主题再到插件应有尽有，写好文章后只需要执行```hexo generate```便可以得到一个静态整站，对于像个人博客这种更新需求不大的网站是再适合不过了。
...
Node.js的版本仍在不断更新中，请至官网下载合适系统类型及架构的安装包。

[Node.js项目下载页](https://nodejs.org/en/download/)

Node.js安装包附带其包管理器NPM。
